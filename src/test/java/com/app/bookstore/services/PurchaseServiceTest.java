...
public class PurchaseServiceTest {
    ...
    public void testPurchaseServiceWithNullOrder() {
        ...
        when(booksRepository.findAllByIsbn(Mockito.anyList())).thenReturn(getExistingBooks());
    ...
    public void testPurchaseOrderWithLess3Book () {
        ...
        when(booksRepository.findAllByIsbn(Mockito.anyList())).thenReturn(getSmallOrder());
